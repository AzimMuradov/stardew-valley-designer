...
package me.azimmuradov.svc.components.cartographer.res

import me.azimmuradov.svc.engine.llsvc.entity.ids.*


object SpritesProvider {

    fun spriteBy(id: SvcEntityId<*>): Sprite = sprites[id] ?: when (id) {
    ...
    private val sprites: MutableMap<SvcEntityId<*>, Sprite> = mutableMapOf()
}