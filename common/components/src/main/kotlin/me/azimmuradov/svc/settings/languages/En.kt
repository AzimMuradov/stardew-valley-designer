...
object En : Language {
    ...
    object Cartographer : Language.Cartographer {
        ...
        override fun menuTitle(x: EntitySelectionRoot): String = entitySelectionMenuTitles[x] ?: when (x) {
        ...
        override fun entity(x: EntityId<*>): String = entities[x] ?: when (x) {
        ...
        override fun tool(type: ToolType): String = tools[type] ?: when (type) {
            ToolType.Hand -> "Hand Tool"
            ToolType.Pen -> "Pen Tool"
            ToolType.Eraser -> "Eraser Tool"
            ToolType.RectSelect -> "Rectangle Select Tool"
            ToolType.EllipseSelect -> "Ellipse Select Tool"
        }.also { tools[type] = it }


        private val entitySelectionMenuTitles: MutableMap<EntitySelectionRoot, String> = mutableMapOf()
