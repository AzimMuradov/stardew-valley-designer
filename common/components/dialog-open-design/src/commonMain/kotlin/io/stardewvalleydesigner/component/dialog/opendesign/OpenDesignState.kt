...
sealed interface OpenDesignState {

    data object NotOpened : OpenDesignState

    data object Empty : OpenDesignState

    data object Loading : OpenDesignState
    ...
    data object Error : OpenDesignState
}
