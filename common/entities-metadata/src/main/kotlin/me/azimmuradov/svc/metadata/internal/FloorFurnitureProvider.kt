...
internal fun floorFurniture(entity: FloorFurniture): EntityMetadata = when (entity) {
    ...
    is RotatableRug.NauticalRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1740, x = 12, y = 54, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.DarkRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1464, x = 24, y = 45, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.RedRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1454, x = 14, y = 45, w = 2, h = 3, r = entity.rotation)
    }
    ...
    is RotatableRug.GreenCottageRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1626, x = 26, y = 50, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.RedCottageRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1621, x = 21, y = 50, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.MysticRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1667, x = 3, y = 52, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.BoneRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1967, x = 15, y = 61, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.SnowyRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1981, x = 29, y = 61, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.PirateRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1905, x = 17, y = 59, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.PatchworkRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1459, x = 19, y = 45, w = 2, h = 3, r = entity.rotation)
    }

    is RotatableRug.FruitSaladRug -> when (entity.rotation) {
        R1 -> TODO()
        R2 -> furniture(id = 1912, x = 24, y = 59, w = 2, h = 3, r = entity.rotation)
    }
