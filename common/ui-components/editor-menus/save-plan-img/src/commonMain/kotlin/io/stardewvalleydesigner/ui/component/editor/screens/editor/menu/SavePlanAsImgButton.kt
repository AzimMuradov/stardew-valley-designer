...
import io.stardewvalleydesigner.ui.component.editor.screens.editor.menu.saveplanasimg.DesignRenderer
import io.stardewvalleydesigner.ui.component.editor.screens.editor.menu.saveplanasimg.nowFormatted
        ...
        onClick = {
            if (!showFileSaver) {
                pathname = run {
                    ...
                    Environment.relative(Environment.getSvdImagesDir(), filename)
                }
                showFileSaver = true
            }
        }
