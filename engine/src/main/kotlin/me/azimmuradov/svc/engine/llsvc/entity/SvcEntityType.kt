...
package me.azimmuradov.svc.engine.llsvc.entity


sealed interface SvcEntityType {
...
object FloorType : SvcEntityType

object FloorFurnitureType : SvcEntityType

sealed interface ObjectType : SvcEntityType {
...
sealed interface EntityWithoutFloorType : SvcEntityType {
