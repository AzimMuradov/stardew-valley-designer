...
sealed class ColoredFarmBuildingFlavor : IdFlavor {
    abstract var building: Color?
    abstract var roof: Color?
    abstract var trim: Color?
}

sealed class ColoredFlavor<out EType : CartographerEntityType> private constructor() : IdFlavor {
